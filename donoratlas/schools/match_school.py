...
DF_SCHOOLS, STRING_ID_MAP, LAW_NAME_TO_IDS, BUSINESS_NAME_TO_IDS, MED_NAME_TO_IDS, ENG_NAME_TO_IDS = read_csv(SCHOOLS_CSV_PATH)
...
def match_string_to_school_id(query):
    """
